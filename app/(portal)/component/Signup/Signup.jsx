  ...
  return (
    <>
      <form
        ...
        className="lg:w-[60%] border border-primary rounded-md bg-white shadow shadow-primary p-4 lg:p-4 flex flex-col justify-center items-center"
      >
        <Image
          src={relative_image_path("logo.png")}
          className="w-[4em] h-[1.5em] lg:w-[7.625em] lg:h-[2.1875em] mb-3"
          height={1000}
          width={1000}
          alt="বাংলা"
        />
        <hr
          className="
               w-full text-[#348739] mb-2 lg:mb-2"
        />
          ...
          <div>
            ...
            <fieldset className="border border-[#979C9E] rounded-md flex items-center py-1 px-2 lg:py-2 lg:px-4 w-full mb-3 ">
              <input
                ...
                placeholder="নিবন্ধনকৃত মোবাইল নম্বর"
              />
              <label htmlFor="phone">
                <svg
        ...
        {step == 2 && (
          <div>
            ...
            <div className="flex justify-between gap-4 pb-5">
              <p className="text-14 text-[#767474]">
                আপনি কি ওটিপি পাচ্ছেন না?
              </p>
              <button
                onClick={() => setTimer(3)}
        ...
        {step == 3 && (
          <div>
            <div className="flex flex-col gap-2 pb-2">
              ...
              <fieldset className="border border-[#979C9E] rounded-md flex items-center py-1 px-2 w-full ">
                <input
                  ...
                  name="phone"
                  id="phone"
                  className="outline-none rounded-md w-full text-13 lg:text-15 text-[#979C9E] placeholder:text-[#979C9E]"
                  placeholder="নিবন্ধনকৃত মোবাইল নম্বর"
                  readOnly
                />
                <label htmlFor="phone">
              ...
              <fieldset className="border border-[#979C9E] rounded-md flex items-center py-1 px-2 w-full ">
                <select
                  name=""
                  id=""
                  className="w-full bg-white text-[#979C9E] text-13 lg:text-15 outline-none rounded-md"
                >
                  <option
                    value=""
                    className="text-[#979C9E] text-13 lg:text-15"
                  >
                    ইউজারের ধরন নির্বাচন করুন
                  </option>
                  <option value="" className="text-13 lg:text-15">
                    সাধারন ইউজার
                  </option>
                  <option value="" className="text-13 lg:text-15">
                    সরকারি কর্মকর্তা
            ...
            <button
              type="submit"
              className="bg-primary text-white px-2 py-1 mb-4 text-14  lg:px-4 lg:py-1 rounded w-full"
            >
              নিবন্ধন করুন
            </button>
          </div>
